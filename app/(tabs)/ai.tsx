...
const INITIAL_MESSAGES: Message[] = [
  ...
  },
  {
    id: '2',
    role: 'user',
    content: "I love the jacket, but can we try different boots? Maybe something more rugged?",
    time: '09:43 AM',
  },
  {
    id: '3',
    ...
    setTimeout(() => {
      setMessages((prev) => [
        ...prev,
        {
          ...
          role: 'ai',
          content: "Great choice! Let me analyze your wardrobe and put together the perfect outfit for you. ✦",
  ...
  return (
    ...
    >
      ...
      <ScrollView
        ...
        contentContainerStyle={{ paddingVertical: 20, gap: 20, paddingBottom: 12 }}
            ...
            {msg.role === 'ai' ? (
              ...
              <View style={styles.userBubbleWrapper}>
                <View style={styles.userBubbleMeta}>
                  ...
                  <Image
                    source={{
                      uri: 'https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?w=60&q=80',
                    }}
      ...
      <View style={[styles.bottomArea, { paddingBottom: insets.bottom || 16 }]}>
        ...
        <View style={styles.inputRow}>
          <View style={styles.inputContainer}>
            ...
            />
            <TouchableOpacity style={styles.inputIconBtn}>
              <Text style={{ color: 'rgba(255,255,255,0.4)', fontSize: 18 }}>🎙️</Text>
            </TouchableOpacity>
          </View>
          <TouchableOpacity
          ...
          >
            <Text style={{ color: '#000', fontSize: 18, fontWeight: '800' }}>↑</Text>
          </TouchableOpacity>
        </View>
      </View>
    </KeyboardAvoidingView>
...
const styles = StyleSheet.create({
  ...
  aiBubble: {
    backgroundColor: CHARCOAL, borderRadius: 18, borderTopLeftRadius: 4,
  ...
  userBubbleMeta: {
    ...
    gap: 6, marginBottom: 4, justifyContent: 'flex-end',
  },
  userAvatarSmall: {
    width: 24, height: 24, borderRadius: 12,
  ...
  userBubble: {
    backgroundColor: BG, borderRadius: 18, borderTopRightRadius: 4,
    padding: 14, borderWidth: 1, borderColor: `${PRIMARY}66`,
  },
  userBubbleText: { color: '#e8e8e8', fontSize: 14, lineHeight: 22 },
  outfitCard: {
    backgroundColor: CHARCOAL, borderRadius: 16, overflow: 'hidden',
  ...
  matchBadge: {
    backgroundColor: `${PRIMARY}33`, borderRadius: 999,
    paddingHorizontal: 8, paddingVertical: 4, borderWidth: 1, borderColor: `${PRIMARY}55`,
  },
  matchBadgeText: { color: PRIMARY, fontSize: 9, fontWeight: '800', textTransform: 'uppercase' },
  outfitItems: {
  ...
  wearBtn: {
    margin: 12, marginTop: 0, backgroundColor: PRIMARY,
  ...
  chip: {
    ...
    backgroundColor: CHARCOAL, borderRadius: 999,
  ...
  textInput: {
    flex: 1, color: '#fff', fontSize: 14, paddingVertical: 8,
    maxHeight: 100,
  },
  sendBtn: {
    width: 46, height: 46, borderRadius: 23,
    backgroundColor: PRIMARY, alignItems: 'center', justifyContent: 'center',
    shadowColor: PRIMARY, shadowRadius: 10, shadowOpacity: 0.4,
  },
});
